...
suite("Models Test Suite", () => {
  ...
  test("CbpProjectItem: should set checkbox state when showCheckbox is true", () => {
    const filePath = p("test.cbp");
    const checkedItem = new CbpProjectItem(
      "TestProject",
      filePath,
      true,
    ...
    const uncheckedItem = new CbpProjectItem(
      "TestProject",
      filePath,
      false,
      vscode.TreeItemCollapsibleState.None,
    ...
    assert.strictEqual(
      checkedItem.checkboxState,
      vscode.TreeItemCheckboxState.Checked,
    );
    assert.strictEqual(
      uncheckedItem.checkboxState,
  ...
  test("CbpProjectItem: should set resourceUri", () => {
    ...
    assert.strictEqual(
      path.normalize(item.resourceUri!.fsPath).toLowerCase(),
  ...
  test("CbpProjectItem: should handle different collapsible states", () => {
    const filePath = p("test.cbp");
    const noneItem = new CbpProjectItem(
      "TestProject",
      filePath,
      true,
      vscode.TreeItemCollapsibleState.None,
    );
    const collapsedItem = new CbpProjectItem(
      "TestProject",
      filePath,
      true,
